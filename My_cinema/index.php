...
<body>
    ...
    <?php
        ...
        //AUCUN TEXTE SAISIE
        // if(empty($name) && empty($genre) && empty($distributeur))
        // {
        //     $accueil = "SELECT title, distributor.name AS distributeur, genre.name AS genre FROM movie
        ...
        //     foreach($data -> query($accueil) as $value)
        //     {
        //         echo $value['title'] . "<br>" . $value['distributeur'] . "<br>" . $value['genre'] . "<br>" . "<br>";
        //     }
        // }
        ...
        elseif(!empty($idmember) && !empty($addmovie))
        {
            ...
            echo "Film ajouté à l'historique de l'abonné $idmember";
        }
